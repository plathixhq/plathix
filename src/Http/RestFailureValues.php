...
final class RestFailureValues
{
	 ...
	 */
	public static function invalidFolder(int $id = 0): array {
	 ...
	 * @return array{id:int,message:string}
	 */
	public static function missingFolder(int $id): array {
	 ...
	 */
	public static function wpError(int $id, \WP_Error $error): array {
		$result = [
			'id'      => $id,
	 ...
	 */
	public static function emptyFolderName(): array {
		return [
			'name'    => '',
	 ...
	 */
	public static function batchCreate(string $name, int $parent_id, \WP_Error $error): array {
		return [
			'name'     => $name,
			'parentId' => $parent_id,
			'code'     => (string) $error->get_error_code(),
	 ...
	 */
	public static function batchCreatedRow(int $id, string $name, int $parent_id): array {
		return [
			'id'       => $id,
			'name'     => $name,
			'parentId' => $parent_id,
