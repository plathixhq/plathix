...
final class RestAuditPayloadBuilders
{
	...
	public static function fromRequest(\WP_REST_Request $request): array {
		return [
			...
			'context'    => self::normalizeContext( $request->get_param( 'context' ) ),
		];
	}
	 ...
	 * @return array<string, mixed>
	 */
	public static function normalizeContext(mixed $context): array {
		if ( is_array( $context ) ) {
			return $context;
		}
	 ...
	 * @return array<string, mixed>
	 */
	public static function importJob(string $adapter, string $post_type, int $job_id): array {
		return [
			'objectType' => 'import',
			'objectId'   => $job_id,
	 ...
	 * @return array<string, mixed>
	 */
	public static function structureExport(string $post_type): array {
		return [
			'objectType' => 'export',
	 ...
	 * @return array<string, mixed>
	 */
	public static function filtersFromRequest(\WP_REST_Request $request): array {
		return [
	...
	public static function exportFormatFromRequest(\WP_REST_Request $request): string {
	 ...
	 */
	public static function entriesResponse(array $result, array $filters): array {
		return [
