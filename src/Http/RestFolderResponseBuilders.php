...
final class RestFolderResponseBuilders
{
	 ...
	 */
	public static function folderItems(array $result, string $taxonomy, int $folder_id, int $page, int $per_page): array {
		return [
	 ...
	 */
	public static function folderSize(int $bytes_own, int $bytes_children): array {
		return [
			'bytes'         => $bytes_own,
	...
	public static function folderSizeCacheKey(int $folder_id, string $taxonomy): string {
