...
final class HookRegistry
{
	...
	public const SLOTS = [
		...
		'infrastructure/temp_dir'                => [ 'type' => 'filter', 'declared_in' => 'src/Infrastructure/TempDirectory.php' ],
		'admin/rootSlug'                        => [ 'type' => 'filter', 'declared_in' => 'src/Modules/Tools/ToolsPage.php' ],
		...
		'cleanup/previewItems'                  => [ 'type' => 'filter', 'declared_in' => 'src/Modules/DataWipe/DangerZoneTab.php' ],
		...
		'system_info/rows'                       => [ 'type' => 'filter', 'declared_in' => 'src/Modules/SystemInfo/SystemInfoProvider.php' ],
		...
		'settings/generalSections'              => [ 'type' => 'filter', 'declared_in' => 'src/Modules/Settings/SettingsView.php' ],
		...
		'taxonomy/ensureSystemTerms'           => [ 'type' => 'action', 'declared_in' => 'src/Core/Taxonomy.php' ],
